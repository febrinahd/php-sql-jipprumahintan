                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="ringkasan" class="form-control" placeholder="Ringkasan Singkat Permasalahan" maxlength="300"><?php echo $ambil['ringkasan']?></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <label>
                                                ...
                                                <textarea name="tujuan_inov" class="form-control" placeholder="Tujuan Inovasi" maxlength="200"><?php echo $ambil['tujuan_inov']?></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <label>
                                                ...
                                                <textarea name="keselarasan" class="form-control" placeholder="Keselarasan dengan Kategori" maxlength="200"><?php echo $ambil['keselarasan']?></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            3. Signifikansi/Arti Penting(Bobot 15%)
                                                ...
                                                <textarea name="signifikansi" class="form-control" placeholder="Signifikansi/Arti Penting" maxlength="200"><?php echo $ambil['signifikansi']?></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            4. Inovatif/Kebaruan Atau Keunikan Atau Keaslian (Bobot 20%)
                                                ...
                                                <textarea name="inovatif" class="form-control" placeholder="Inovatif/Keunikan/Keaslian" maxlength="200"><?php echo $ambil['inovatif']?></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class ="row">
                                            ...
                                            <label>
                                                5. Transferabilitas (Sifat Dapat Diterapkan Pada Konteks/Tempat Lain) (Bobot 10%)
                                                    ...
                                                    <textarea name="sifat" class="form-control" placeholder="Transferabilitas" maxlength="200"><?php echo $ambil['sifat']?></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            6. Sumber Daya Dan Keberlanjutan (Bobot 10%)
                                                    ...
                                                    <textarea name="sumberdaya" class="form-control" placeholder="Sumber Daya" maxlength="200"><?php echo $ambil['sumberdaya']?></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <label>
                                                    ...
                                                    <textarea name="keberlanjutan" class="form-control" placeholder="Keberlanjutan" maxlength="200"><?php echo $ambil['keberlanjutan']?></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <label>
                                                7. Dampak (Bobot 15%)
                                                    ...
                                                    <textarea name="dampak" class="form-control" placeholder="Dampak" maxlength="200"><?php echo $ambil['dampak']?></textarea>
                                            </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="indikator" class="form-control" placeholder="Indikator yang Digunakan" maxlength="200"><?php echo $ambil['indikator']?></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="hasil_eval" class="form-control" placeholder="Gambaran Hasil Evaluasi" maxlength="200"><?php echo $ambil['hasil_eval']?></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <label>
                                                ...
                                                <textarea name="kolaborasi" class="form-control" placeholder="Keterlibatan Pemangku Kepentingan" maxlength="200"><?php echo $ambil['kolaborasi']?></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            9. Pelajaran Yang Dipetik (Bobot 10%)
                                                ...
                                                <textarea name="pelajaran" class="form-control" placeholder="Pelajaran yang Diambil" maxlength="200"><?php echo $ambil['pelajaran']?></textarea>
                                            </div>
                                            </div>
                                        </div>
    ...
    <div class="modal-dialog">
      ...
      <form method="post">
        ...
        <div class="modal-body">
          ...
          <input type="hidden" name="id" value="<?php echo $userdataid; ?>">
