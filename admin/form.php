...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $insert = mysqli_query($conn,"update userdata set status_pro='$status_pro' where userdataid='$userdataid'");
        if($insert){
            //berhasil bikin
          ...
          <meta http-equiv='refresh' content='1; url= form.php'/>  ";  
            ...
            echo "<div class='alert alert-warning'>
                  Gagal ubah status. Silakan coba lagi nanti.
              </div>
										 ...
										 <table id="dataTable3" class="table table-hover" style="width:100%"><thead class="thead-dark">
											...
											while($b=mysqli_fetch_array($form)){
												...
												<tr>
                                                    ...
                                                    ?>
                                                    <td><a class="btn btn-warning" href="ubah_status.php?u=<?php echo $b['userdataid'];?>"><?php echo $b['status_pro']?></a></td>
                                                    <?php } 
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Ubah Status Proposal</h4>
						</div><form method="post">
                            <input type="hidden" name="userdataid" value="">
