...
<head>
    ...
    <title>JIPP Rumah Intan: Tampilkan Pendaftar</title>
                                ...
                                <div class="market-status-table mt-4">
                                    ...
                                    <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input name="judul" type="text" class="form-control" placeholder="Judul Inovasi" maxlength="12" value="<?php echo $ambil['judul']?>" disabled>
                                            </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="instansi" type="text" class="form-control" placeholder="Asal Instansi" maxlength="16" value="<?php echo $ambil['instansi']?>" disabled>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="inovator" type="text" class="form-control" placeholder="Penanggung Jawab/Inovator" maxlength="50" value="<?php echo $ambil['inovator']?>" disabled>
                                            </div>
                                            </div>
                                            <div class="col">
                                            <div class="form-group">
                                                <label>Alamat Instansi*</label>
                                                <input name="alamat_ins" type="text" class="form-control" placeholder="Alamat Instansi" maxlength="50" value="<?php echo $ambil['alamat_ins']?>" disabled>
                                            </div>
                                            </div>                          
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="notelp" type="text" class="form-control" placeholder="Nomor Telepon Aktif" maxlength="20" value="<?php echo $ambil['notelp']?>" disabled>
                                            </div>
                                            </div>
                                            <div class="col">
                                            <div class="form-group">
                                                <label>Tanggal Inovasi Dimulai*</label>
                                                <input name="tgl_inov" type="date" class="form-control" value="<?php echo $ambil['tgl_inov']?>" disabled>
                                            </div>
                                            </div>
                                        </div>
                                            <div class="form-group">
                                                <label>Email*</label>
                                                <input name="email" type="text" class="form-control" placeholder="Alamat Email Aktif"value="<?php echo $ambil['email']?>"disabled>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input name="provinsi" type="text" class="form-control" value="<?php echo $ambil['provinsi']?>" disabled>
                                        </div>
                                        </div>
                                        <div class="col">
                                        <div class="form-group">
                                            <label>Kota/Kabupaten*</label>
                                            <input name="kota" type="text" class="form-control" value="<?php echo $ambil['kota']?>" disabled>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="kecamatan" type="text" class="form-control" value="<?php echo $ambil['kecamatan']?>" disabled>
                                        </div>
                                        </div>
                                        <div class="col">
                                        <div class="form-group">
                                            <label>Kelurahan/Desa/Dusun*</label>
                                            <input name="kelurahan" type="text" class="form-control" value="<?php echo $ambil['kelurahan']?>" disabled>
                                        </div>
                                        </div>
                                    </div>
                                ...
                                <div class="market-status-table mt-4">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="kategori" type="text" class="form-control" placeholder="Kategori Inovasi" maxlength="16" value="<?php echo $ambil['kategori']?>"disabled>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="ringkasan" class="form-control" placeholder="Ringkasan Singkat Permasalahan" maxlength="300"value="<?php echo $ambil['ringkasan']?>"disabled></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <label>
                                                ...
                                                <textarea name="tujuan_inov" class="form-control" placeholder="Tujuan Inovasi" maxlength="200"value="<?php echo $ambil['tujuan_inov']?>"disabled></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <label>
                                                ...
                                                <textarea name="keselarasan" class="form-control" placeholder="Keselarasan dengan Kategori" maxlength="200"value="<?php echo $ambil['keselarasan']?>"disabled></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            3. Signifikansi/Arti Penting(Bobot 15%)
                                                ...
                                                <textarea name="signifikansi" class="form-control" placeholder="Signifikansi/Arti Penting" maxlength="200"value="<?php echo $ambil['signifikansi']?>"disabled></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            4. Inovatif/Kebaruan Atau Keunikan Atau Keaslian (Bobot 20%)
                                                ...
                                                <textarea name="inovatif" class="form-control" placeholder="Inovatif/Keunikan/Keaslian" maxlength="200"value="<?php echo $ambil['inovatif']?>"disabled></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class ="row">
                                            ...
                                            <label>
                                                5. Transferabilitas (Sifat Dapat Diterapkan Pada Konteks/Tempat Lain) (Bobot 10%)
                                                    ...
                                                    <textarea name="sifat" class="form-control" placeholder="Transferabilitas" maxlength="200"value="<?php echo $ambil['sifat']?>"disabled></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            6. Sumber Daya Dan Keberlanjutan (Bobot 10%)
                                                    ...
                                                    <textarea name="sumberdaya" class="form-control" placeholder="Sumber Daya" maxlength="200"value="<?php echo $ambil['sumberdaya']?>"disabled></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <label>
                                                    ...
                                                    <textarea name="keberlanjutan" class="form-control" placeholder="Keberlanjutan" maxlength="200"value="<?php echo $ambil['keberlanjutan']?>"disabled></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <label>
                                                7. Dampak (Bobot 15%)
                                                    ...
                                                    <textarea name="dampak" class="form-control" placeholder="Dampak" maxlength="200"value="<?php echo $ambil['dampak']?>"disabled></textarea>
                                            </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="indikator" class="form-control" placeholder="Indikator yang Digunakan" maxlength="200"value="<?php echo $ambil['indikator']?>"disabled></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="hasil_eval" class="form-control" placeholder="Gambaran Hasil Evaluasi" maxlength="200"value="<?php echo $ambil['hasil_eval']?>"disabled></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <label>
                                                ...
                                                <textarea name="kolaborasi" class="form-control" placeholder="Keterlibatan Pemangku Kepentingan" maxlength="200"value="<?php echo $ambil['kolaborasi']?>"disabled></textarea>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            9. Pelajaran Yang Dipetik (Bobot 10%)
                                                ...
                                                <textarea name="pelajaran" class="form-control" placeholder="Pelajaran yang Diambil" maxlength="200"value="<?php echo $ambil['pelajaran']?>"disabled></textarea>
                                            </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                            <div class="form-group">
                                                <input type="hidden" value="<?=$userdataid;?>" name="userdataid">
                                            </div>
                                            </div>
                                        </div>
                                        </div>
                                ...
                                <div class="market-status-table mt-4">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="drive" type="text" class="form-control" placeholder="Link Drive" maxlength="12"value="<?php echo $ambil['drive']?>"disabled>
                                            </div>
                                            </div>
                                            <div class="col">
                                            <div class="form-group">
                                                <label>Link Youtube</label>
                                                <input name="youtube" type="text" class="form-control" placeholder="Link Youtube" maxlength="40"value="<?php echo $ambil['youtube']?>"disabled>
                                            </div>
                                            </div>
                                        </div>

                                        <div class="modal-footer">
                                        <td><button onclick="window.print()">Cetak</button></td>
                                        </div>
