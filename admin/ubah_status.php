...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $userdataid = $_POST['id'];
        $update = mysqli_query($conn,"update userdata set status_pro='$status_pro' where userdataid='$userdataid'");
        if($update){ 
            if($status_pro == 'dikembalikan'){
                $update1 = mysqli_query($conn,"update userdata set status='Unverified' where userdataid='$userdataid'");
            }
            //berhasil bikin
            ...
            echo "<div class='alert alert-warning'>
                ...
                <meta http-equiv='refresh' content='3; url= ubah_status.php?u=$id'/> ";
            }
										 ...
										 <table id="dataTable3" class="table table-hover" style="width:100%"><thead class="thead-dark">
											<tr>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="status_pro"class="form-control">
                                                    
                                                        <option value="<?php echo $status_pro['in_process']?>">In Process</option>
