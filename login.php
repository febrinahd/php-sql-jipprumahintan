...
.btn{
  ...
  <h1 style = "color:white ; margin-top:2%" width="50%" \>Login User</p></h1>

	<br \><br \>
			<div class="container">
					<div style="color:white">
					<label>Login</label><br \>
					<label>Email: febrina@gmail.com  |  Password : 123456</label>
					</div>
                <form method="post">
				...
				<br>
					<a href="https://wa.me/628978162107?text=Selamat Pagi/Siang/Sore Admin">Forgot Password</a>
			<br>
        </div></div>
