...
<html lang="en">
    <head>
        ...
        <title>Pendaftaran JIPP 2023 Online</title>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">JIPP Rumah Intan</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="assets/img/pemprov_logo.png" alt="" />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Kompetisi Jaringan Inovasi Pelayanan Publik (JIPP)</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Dinas Kesehatan Provinsi Sumatera Selatan</p>
            </div>
        </header>
        <!-- Portfolio Section-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="panduan">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto"><p class="lead">JIPP merupakan kompetisi jaringan inovasi pelayanan publik yang diadakan oleh Dinas Kesehatan Provinsi Sumatera Selatan setiap tahunnya.Pendaftaran Kompetisi JIPP akan dibuka untuk tahun 2023 pada ....</p></div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <p class="lead mb-0">
                            Telp : (0711) - 354915, Fax (0711) - 351749, (0711) - 321707
                        </p>
                    </div>
                    <!-- Footer Social Icons-->
                    <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="lead mb-0">
                            Jl. Dr. M. Ali Komplek RSUP Dr. Moch Hoesin Palembang. Kode Pos : 30126
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>JIPP Rumah Intan - 2023</small></div>
        </div>
